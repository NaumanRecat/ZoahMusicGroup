    ...
    return (
        <View style={{ flex: 1, backgroundColor: BackgroundClr }}>
            ...
            <ScrollView style={{ marginRight: W(3), padding: 5 }}>
                ...
                <Text style={{ color: 'rgba(255, 255, 255, 0.7)', marginBottom:H(1)   }}> i. Placing your song(s) under the Zoah Music Group catalog</Text>
                <Text style={{ color: 'rgba(255, 255, 255, 0.7)', marginBottom:H(1)    }}> ii. Inputting your song(s) metadata into our database for correct splits and ownership information, to ensure that all future distributions are accurate.</Text>
                <Text style={{ color: 'rgba(255, 255, 255, 0.7)', marginBottom:H(1)    }}> iii. Acting in a legal capacity as your Administrative Publisher in that capacity, ZOAH MUSIC GROUP shall represent the publishing needs of the individual/company named below as it pertains to the song(s) listed on the attached SONG REGISTRATION form.</Text>
                <Text style={{ color: 'rgba(255, 255, 255, 0.7)', marginBottom:H(1)    }}> iv. Individual/Company named below shall have the legal right to assign all works to this AGREEMENT by either owning or controlling all or a portion of the Copyright, by owning or controlling all or a portion of the publishing, or by being a legal representative of one who owns and or controls a portion of the Copyright or Publishing.</Text>
                <Text style={{ color: 'rgba(255, 255, 255, 0.7)', marginBottom:H(1)    }}> v. Individual/Company may be only a composer, author, or both of the work(s), this gives the Individual/Company the legal right to assign work(s) to ZOAH MUSIC GROUP.</Text>
                <Text style={{ color: 'rgba(255, 255, 255, 0.7)', marginBottom:H(1)    }}> vi. When assigning work(s) to ZOAH MUSIC GROUP you hereby grant to ZOAH MUSIC GROUP the right to collect and distribute royalties on your behalf in consideration for a 20% payment on all gross royalties collected via ZOAH MUSIC GROUP on behalf of Individual/Company named below.</Text>
                <Text style={{ color: 'rgba(255, 255, 255, 0.7)', marginBottom:H(1)    }}> vii. Understanding that ZOAH MUSIC GROUP receives royalties every quarter around the 15th of February, May, August, and November, from its administrators (Blue Water and Word Collections) music publishers, ZOAH MUSIC GROUP will payout to its members on the 20th of February, May, August, and November.</Text>
                <Text style={{ color: 'rgba(255, 255, 255, 0.7)', marginBottom:H(1)    }}> viii. Royalties will be paid in the form of ACH or Check based on your preference.</Text>
                <Text style={{ color: 'rgba(255, 255, 255, 0.7)', marginBottom:H(1)    }}> viii. Royalties will be paid in the form of ACH or Check based on your preference.</Text>
                <Text style={{ color: 'rgba(255, 255, 255, 0.7)', marginBottom:H(1)    }}> ix. The term of this contract shall be up and until you end it, understanding that when you officially inform ZOAH MUSIC GROUP in writing that you wish to end this contract/AGREEMENT, it will be legally concluded 45 days after receipt of such. Up until the 45 day mark, ZOAH MUSIC GROUP will continue to collect and serve as ADMINISTRATIVE PUBLISHER as we close out your metadata.</Text>
                <Text style={{ color: 'rgba(255, 255, 255, 0.7)', marginBottom:H(1)    }}> x. Individual/Company may at any time resume the services of ZOAH MUSIC GROUP after a sixty-day period has passed from the time of any AGREEMENT ending.</Text>
                </View>
